 ...
 */
 ...
 output nameTemplate string = nameTemplate
 output nameUniqueTemplate string = nameUniqueTemplate
 output nameSafeTemplate string = nameSafeTemplate
 output nameUniqueSafeTemplate string = nameUniqueSafeTemplate
 output names object = {
